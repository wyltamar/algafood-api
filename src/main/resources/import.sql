...
insert into estado(nome) values('Ceará');
insert into cidade(nome,estado_id) values('Jericó',1);
insert into cidade(nome,estado_id) values('Pombal',1);
insert into cidade(nome,estado_id) values('Catolé do Rocha',1);
